...
const TEXT := {
	"en": {
		...
		"offline_rewards": "Offline Rewards",
		"you_were_away_for": "You were away for",
		"double_with_ad": "Double with Ad",
		"no_offline_rewards": "No offline rewards",
		"max_offline_time_reached": "Max offline time reached",
	...
	"pt": {
		...
		"chest_found": "Baú Encontrado",
		"key_found": "Chave Encontrada",
		"reward_drop": "Drop de Recompensa",
		...
		"offline_rewards": "Recompensas Offline",
		"you_were_away_for": "Você ficou fora por",
		"double_with_ad": "Dobrar com Anúncio",
		"no_offline_rewards": "Sem recompensas offline",
		"max_offline_time_reached": "Tempo offline máximo atingido",
